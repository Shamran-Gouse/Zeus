                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php if($messagecount == ""){$messagecount = 0; print("$messagecount"); } else { print("$messagecount");}?></div>
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php if($Ordercount == ""){$Ordercount = 0; print("$Ordercount"); } else { print("$Ordercount");}?></div>
                                        <div>New Orders!</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php print("$productscount"); ?></div>
                                        <div>Products</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php print("$clientcount");?></div>
                                        <div>Clients</div>
                                    </div>
                                </div>
                            </div>
