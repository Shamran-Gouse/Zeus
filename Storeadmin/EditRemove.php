...
if (isset($_POST['Name'])) {
	...
	if($result){
		...
		echo ''.$pid.'<br>'.$product_name.'<br>'.$quantity.'<br>'.$reorder.'<br>'.$price.'<br>'.$details.'';
		//header("location: editRemove.php?error");
		exit();
	}
...
if (isset($_GET['deleteid']) && !empty($_GET['deleteid'])) {
	...
	$id = $_GET['deleteid'];
	echo 'Do you really want to delete product with ID of '.$id.'? <a href="EditRemove.php?yesdelete='.$id.'"> Yes </a> | <a href="EditRemove.php?pid='.$id.'">No</a>';
	exit();
}
...
<head>
    ...
    <title> Zeus - Edit/Remove Products </title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-times"></i> Edit / Remove Products
                            </li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-md-8">
						<div class="panel panel-default" style="margin:3% 0% 4% 10%;">
							<div class="panel-heading">
								<strong> Edit / Remove Products In Inventry </strong>
							</div> <!--END pannel heading-->
							<div class="panel-body" style="margin:3% 5% 4% 3%;  width:94%">
								<form action="EditRemove.php" method="post" enctype="multipart/form-data">							
										...
										<br>
											<div class="row">
												<div class="col-md-offset-2 col-md-4">
													<a href="EditRemove.php?deleteid=<?php echo $id; ?>" type="button" class="btn btn-danger" id="submitted"> Delete Product</a>
												</div>
