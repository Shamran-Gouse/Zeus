...
if(isset($_POST['search'])){
	...
	$query = "SELECT * FROM admin WHERE Id LIKE '%$searchq%' OR username LIKE '%$searchq%'";
	$result = mysqli_query($db_conx, $query);

	if(mysqli_num_rows($result) == 0){ // evaluate the count
	
			echo '<script type="text/javascript">
				location.replace("search_Admin_User.php?error");
			  </script>';
		 //header("location: search_Admin_User.php?error"); 
		 exit();
	}
	else
	{
...
<head>
    ...
    <title> Zeus - Admin User Search </title>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-user"></i> Search Admin User
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<ul class="nav nav-tabs">
				  ...
				  <li class="active"><a href="search_Admin_User.php"> Admin User </a></li>
				...
				<div class="row">
					<div class="col-xs-offset-1 col-xs-10 col-xs-offset-1" style="margin-top:20px; margin-bottom:20px;">
						<form action="search_Admin_User.php" method="post">
